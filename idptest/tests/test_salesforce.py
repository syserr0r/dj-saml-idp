...
SAML_REQUEST = base64.b64encode(
    (
        ...
        'xmlns:ds="http://www.w3.org/2000/09/xmldsig#"/>'
        '<ds:Reference '
        'URI="#_23_w1uySFqdqmNiZz17aYPnxrtIgaREEtADQVlNz4KrWC4aSYvJcwfdqKOg7K_WDhRQN4u.r.L8T6.uF_.jedrRE9erwC8pQW3DU3QqWHHMkgcQM.YaRfs.k2fRuxJy1LWTpkBKclS7wEetDew124SVn9IXC1S101qA1UPzOnym4WISbxLqIN9zJUNoafpSEkmm3cVrrALn1d5fvpbxWnFACsOVfCrA" '
        'xmlns:ds="http://www.w3.org/2000/09/xmldsig#">'
        ...
        'xmlns:ds="http://www.w3.org/2000/09/xmldsig#">'
        'rExn4AG/W4/cu3'
        '/CGbUAdhFua7yQoJmGnLeaH0QaQpUphLsulG9jpRBuS7Zuyqy4UtEd9j4B1syo'
        't9A7azz+3+eYeg'
        '/86OiQ2rZjlphjsbQIocvVlUd40taSH13gMQ9gMsuYy01WjkcM2vlXA9cHK8Ge'
        'F/6hgRQGpVSzrXMO0ro=</ds:SignatureValue><ds:KeyInfo><ds:X509Data>'
        '<ds:X509Certificate>'
        'MIIEijCCA/OgAwIBAgIQPn+ClEjH2V3Jynt7u3v'
        '+XzANBgkqhkiG9w0BAQUFADCBujEfMB0GA1UE'
        ...
        'p9vqkf9DvnhOJc09GNYKOdz5PkpJ'
        '/bFLuN2frmfJTlw6pi4knE2geN3j26iAFGIpqgkfWmAi5knj'
        'cIbOvHbMXMg1apuVyK9jmbKy4pITZCj56PtH7qMjlmwN+ZEcQRVy+urRGJRfBEyE'
        '+ht5KrewhlcC'
        ...
        'A1UdJQQtMCsGCWCGSAGG'
        '+EIEAQYKKwYBBAGCNwoDAwYIKwYBBQUHAwEGCCsGAQUFBwMCMHEGCCsG'
        ...
        'hvcNAQEFBQADgYEAHP9jTz8c1r9YoOhVxbGwdPx/YU4OaEaiJFqRKrdXu4m6tHp2iW7o'
        '/7Kc8Ixk'
